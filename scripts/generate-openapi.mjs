...
const openapi = {
  openapi: '3.0.3',
  info: {
    title: 'Hermes Fleet API',
    description: 'Hermes Fleet API — chat sessions, scheduled jobs, platform channels, model management, skills, memory, logs, file browser, group chat, and terminal.',
...
openapi.paths['/api/chat-run/runs'] = {
  post: {
    ...
    description: 'Starts a Hermes Fleet chat run through the chat-run transport and waits for a terminal result. Use this from HTTP/MCP callers that cannot consume Socket.IO streams.',
        ...
        'application/json': {
          schema: {
            ...
            properties: {
              ...
              profile: {
                type: 'string',
                description: 'Hermes Fleet profile name. Defaults to the authenticated request profile or default.',
              },
              provider: {
                type: 'string',
