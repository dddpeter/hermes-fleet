...
<p align="center">
  <img src="https://gitee.com/dddpeter/hermes-fleet/raw/main/packages/client/src/assets/image.gif" alt="Hermes Web UI 演示" width="680"/>
</p>
...
- Ekko Agent 支持 runtime context、浏览器工具和稳定的工具事件交付
- 工作区运行 diff 卡片 — 在聊天时间线中直接查看每次 Agent 运行的文件级变更
- 会话级 API mode 持久化，清晰展示推理与上下文设置
