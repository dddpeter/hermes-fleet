...
jobTriggered: 'Job ejecutado',
  ...
  changelog: {
    ...
    new_0_7_0_1: 'Rebrand: Hermes Web UI ahora es Hermes Fleet, repositorio migrado a Gitee con logo e iconos actualizados',
    new_0_7_0_2: 'Seguridad: corregida vulnerabilidad de aislamiento de archivos multi-perfil — los directorios de perfil faltantes ya no retroceden silenciosamente al raiz',
    new_0_7_0_3: 'Ekko Agent integrado en el chat con contexto en tiempo de ejecucion, herramientas de navegador, eventos de herramienta estables y seguimiento de uso de contexto',
    new_0_7_0_4: 'Anadida vista de grafo de aprendizaje de Journey con exploracion de grafo interactiva',
    new_0_7_0_5: 'Los cambios de workspace run ahora aparecen como tarjetas diff en el chat, con soporte para workspace de sistema de archivos',
    new_0_7_0_6: 'Las sesiones de Coding Agent muestran razonamiento y configuracion de contexto mas claramente, persisten el modo API y corrigen saltos en el uso de contexto',
    new_0_7_0_7: 'MCP available-models devuelve un resumen compacto por defecto para evitar inundar el contexto del agente',
    new_0_7_0_8: 'Eliminada la entrada de descarga de escritorio, la configuracion de Docker Compose y el componente de insignia de circuito de configuracion',
  },
}
