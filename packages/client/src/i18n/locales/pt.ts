export default {
  ...
  runtimeVersions: {
    ...
    activateSuccess: 'Seleção de versão salva. Reinicie o Hermes Fleet para usá-la.',
    jobStatus: {
      queued: 'Na fila',
      running: 'Em execução',
      completed: 'Concluída',
...
jobTriggered: 'Job acionado',
  ...
  changelog: {
    ...
    new_0_7_0_1: 'Rebrand: Hermes Web UI agora e Hermes Fleet, repositorio migrado para Gitee com logo e icones atualizados',
    new_0_7_0_2: 'Seguranca: corrigida vulnerabilidade de isolamento de arquivos multi-perfil — diretorios de perfil ausentes nao retrocedem silenciosamente para a raiz',
    new_0_7_0_3: 'Ekko Agent integrado ao chat com contexto de runtime, ferramentas de navegador, eventos de ferramenta estaveis e rastreamento de uso de contexto',
    new_0_7_0_4: 'Adicionada visualizacao de grafo de aprendizado Journey com exploracao interativa do grafo',
    new_0_7_0_5: 'Alteracoes de workspace run agora aparecem como cards de diff no chat, com suporte a workspace de sistema de arquivos',
    new_0_7_0_6: 'Sessoes do Coding Agent exibem raciocinio e configuracoes de contexto mais claramente, persistem o modo API e corrigem saltos no uso de contexto',
    new_0_7_0_7: 'MCP available-models retorna um resumo compacto por padrao para evitar inundar o contexto do agente',
    new_0_7_0_8: 'Removida entrada de download desktop, configuracao Docker Compose e componente de badge de circuito de configuracoes',
  },
}
