...
jobTriggered: 'Job ausgelost',
  ...
  changelog: {
    ...
    new_0_7_0_1: 'Rebranding: Hermes Web UI heisst nun Hermes Fleet, das Repository wurde nach Gitee migriert, Logo und Symbole wurden aktualisiert',
    new_0_7_0_2: 'Sicherheit: Isolationsluecke bei Multi-Profil-Dateien behoben — fehlende Profilverzeichnisse fallen nicht mehr stillschweigend auf das Root-Verzeichnis zurueck',
    new_0_7_0_3: 'Ekko Agent in den Chat integriert mit Laufzeitkontext, Browser-Tools, stabilen Tool-Ereignissen und Kontextnutzungsverfolgung',
    new_0_7_0_4: 'Journey-Lerngraphenansicht mit interaktiver Graphenexploration hinzugefuegt',
    new_0_7_0_5: 'Workspace-Aenderungen werden nun als Chat-Diff-Karten angezeigt, mit Unterstuetzung fuer Dateisystem-Workspaces',
    new_0_7_0_6: 'Coding-Agent-Sitzationen zeigen Schlussfolgerung und Kontexteinstellungen klarer, behalten den API-Modus bei und beheben Kontextnutzungsspruenge',
    new_0_7_0_7: 'MCP available-models gibt standardmaessig eine kompakte Zusammenfassung zurueck, um den Agentenkontext nicht zu ueberfluten',
    new_0_7_0_8: 'Desktop-Download-Eintrag, Docker-Compose-Konfiguration und Einstellungs-Circuit-Badge-Komponente entfernt',
  },
}
