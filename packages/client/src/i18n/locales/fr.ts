export default {
  ...
  runtimeVersions: {
    ...
    activateSuccess: 'Sélection de version enregistrée. Redémarrez Hermes Fleet pour l’utiliser.',
    jobStatus: {
      queued: 'En attente',
      running: 'En cours',
      completed: 'Terminé',
...
jobTriggered: 'Job declenche',
  ...
  changelog: {
    ...
    new_0_7_0_1: 'Rebranding: Hermes Web UI devient Hermes Fleet, le depot a ete migre vers Gitee, avec un logo et des icones mis a jour',
    new_0_7_0_2: 'Securite: correction de la vulnerabilite d isolation des fichiers multi-profils — les repertoires de profil manquants ne retombent plus silencieusement sur la racine',
    new_0_7_0_3: 'Ekko Agent integre au chat avec le contexte d execution, les outils navigateur, les evenements d outil stables et le suivi d utilisation du contexte',
    new_0_7_0_4: 'Vue du graphe d apprentissage Journey ajoutee avec exploration interactive du graphe',
    new_0_7_0_5: 'Les modifications d execution du workspace apparaissent desormais sous forme de cartes de diff dans le chat, avec prise en charge du workspace filesystem',
    new_0_7_0_6: 'Les sessions Coding Agent affichent plus clairement le raisonnement et les parametres de contexte, persistent le mode API et corrigent les sauts d utilisation du contexte',
    new_0_7_0_7: 'MCP available-models renvoie un resume compact par defaut pour eviter de inonder le contexte de l agent',
    new_0_7_0_8: 'Suppression de l entree de telechargement desktop, de la configuration Docker Compose et du composant badge de circuit des parametres',
  },
}
