  ...
  <aside class="sidebar" :class="{ open: appStore.sidebarOpen, collapsed: appStore.sidebarCollapsed }" @click="handleSidebarClick">
    ...
    <div class="sidebar-footer">
      ...
      <div class="version-info">
        <a class="sidebar-footer-link" href="https://gitee.com/dddpeter/hermes-fleet" target="_blank" rel="noopener noreferrer" title="Gitee">
        ...
        >
          Fleet v{{ appStore.serverVersion || "0.1.0" }}
        </span>
        <ThemeSwitch />
      </div>
