...
const translations: Record<DesktopLocale, Record<TranslationKey, string>> = {
  en: {
    'tray.show': 'Show Hermes Fleet',
    'tray.hide': 'Hide Hermes Fleet',
    'tray.checkForUpdates': 'Check for Updates',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Open at Login',
    'tray.quit': 'Quit Hermes Fleet',
    'update.upToDateTitle': 'Hermes Fleet',
    'update.upToDateMessage': 'Hermes Fleet is up to date.',
    'update.checkingTitle': 'Hermes Fleet',
    ...
    'update.availableMessage': 'Hermes Fleet {version} is available.',
    'update.downloading': 'The update is downloading in the background.',
    'update.readyTitle': 'Update ready',
    'update.readyMessage': 'Hermes Fleet {version} is ready to install.',
    ...
    'update.failedMessage': 'Could not check for Hermes Fleet updates.',
    ...
    'desktop.downloadCloudflareDetail': 'Use the Hermes Fleet download proxy.',
    ...
    'loginReset.confirmDetail': 'Hermes Fleet will restart its local Web UI service, clear login locks, and return to the login page.',
  ...
  zh: {
    ...
    'desktop.downloadCloudflareDetail': '使用 Hermes Fleet 下载代理。',
    ...
    'loginReset.confirmDetail': 'Hermes Fleet 会重启本地 Web UI 服务、清除登录失败锁，然后回到登录页。',
  ...
  'zh-TW': {
    'tray.show': '顯示 Hermes Fleet',
    'tray.hide': '隱藏 Hermes Fleet',
    'tray.checkForUpdates': '檢查更新',
    'tray.resetLogin': '重置登入',
    'tray.openAtLogin': '開機啟動',
    'tray.quit': '結束 Hermes Fleet',
    'update.upToDateTitle': 'Hermes Fleet',
    'update.upToDateMessage': 'Hermes Fleet 已是最新版本。',
    'update.checkingTitle': 'Hermes Fleet',
    ...
    'desktop.downloadCloudflareDetail': '使用 Hermes Fleet 下載代理。',
    ...
    'loginReset.confirmDetail': 'Hermes Fleet 會重新啟動本地 Web UI 服務、清除登入失敗鎖，然後回到登入頁。',
  ...
  ja: {
    ...
    'desktop.downloadCloudflareDetail': 'Hermes Fleet のダウンロードプロキシを使用します。',
  ...
  ko: {
    'tray.show': 'Hermes Fleet 표시',
    'tray.hide': 'Hermes Fleet 숨기기',
    'tray.checkForUpdates': '업데이트 확인',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': '로그인 시 열기',
    'tray.quit': 'Hermes Fleet 종료',
    'update.upToDateTitle': 'Hermes Fleet',
    'update.upToDateMessage': 'Hermes Fleet가 최신 버전입니다.',
    'update.checkingTitle': 'Hermes Fleet',
    'update.checkingMessage': '업데이트를 확인하는 중...',
    'update.currentVersion': '현재 버전: {version}',
    'update.availableTitle': '업데이트 사용 가능',
    'update.availableMessage': 'Hermes Fleet {version}을 사용할 수 있습니다.',
    'update.downloading': '업데이트를 백그라운드에서 다운로드하고 있습니다.',
    'update.readyTitle': '업데이트 준비 완료',
    'update.readyMessage': 'Hermes Fleet {version}을 설치할 준비가 되었습니다.',
    ...
    'update.failedMessage': 'Hermes Fleet 업데이트를 확인할 수 없습니다.',
    ...
    'desktop.downloadCloudflareDetail': 'Hermes Fleet 다운로드 프록시를 사용합니다.',
  ...
  fr: {
    'tray.show': 'Afficher Hermes Fleet',
    'tray.hide': 'Masquer Hermes Fleet',
    'tray.checkForUpdates': 'Rechercher les mises a jour',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Ouvrir a la connexion',
    'tray.quit': 'Quitter Hermes Fleet',
    'update.upToDateTitle': 'Hermes Fleet',
    'update.upToDateMessage': 'Hermes Fleet est a jour.',
    'update.checkingTitle': 'Hermes Fleet',
    ...
    'update.availableMessage': 'Hermes Fleet {version} est disponible.',
    'update.downloading': 'La mise a jour se telecharge en arriere-plan.',
    'update.readyTitle': 'Mise a jour prete',
    'update.readyMessage': 'Hermes Fleet {version} est pret a etre installe.',
    ...
    'update.failedMessage': 'Impossible de rechercher les mises a jour de Hermes Fleet.',
    ...
    'desktop.downloadCloudflareDetail': 'Utilise le proxy de telechargement Hermes Fleet.',
  ...
  es: {
    'tray.show': 'Mostrar Hermes Fleet',
    'tray.hide': 'Ocultar Hermes Fleet',
    'tray.checkForUpdates': 'Buscar actualizaciones',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Abrir al iniciar sesion',
    'tray.quit': 'Salir de Hermes Fleet',
    'update.upToDateTitle': 'Hermes Fleet',
    'update.upToDateMessage': 'Hermes Fleet esta actualizado.',
    'update.checkingTitle': 'Hermes Fleet',
    ...
    'update.availableMessage': 'Hermes Fleet {version} esta disponible.',
    'update.downloading': 'La actualizacion se esta descargando en segundo plano.',
    'update.readyTitle': 'Actualizacion lista',
    'update.readyMessage': 'Hermes Fleet {version} esta listo para instalarse.',
    ...
    'update.failedMessage': 'No se pudieron buscar actualizaciones de Hermes Fleet.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa el proxy de descarga de Hermes Fleet.',
  ...
  de: {
    'tray.show': 'Hermes Fleet anzeigen',
    'tray.hide': 'Hermes Fleet ausblenden',
    'tray.checkForUpdates': 'Nach Updates suchen',
    'tray.resetLogin': 'Reset Login',
    'tray.openAtLogin': 'Beim Anmelden offnen',
    'tray.quit': 'Hermes Fleet beenden',
    'update.upToDateTitle': 'Hermes Fleet',
    'update.upToDateMessage': 'Hermes Fleet ist auf dem neuesten Stand.',
    'update.checkingTitle': 'Hermes Fleet',
    ...
    'update.availableMessage': 'Hermes Fleet {version} ist verfugbar.',
    'update.downloading': 'Das Update wird im Hintergrund heruntergeladen.',
    'update.readyTitle': 'Update bereit',
    'update.readyMessage': 'Hermes Fleet {version} ist zur Installation bereit.',
    ...
    'update.failedMessage': 'Updates fur Hermes Fleet konnten nicht gepruft werden.',
    ...
    'desktop.downloadCloudflareDetail': 'Verwendet den Hermes Fleet Download-Proxy.',
  ...
  pt: {
    ...
    'tray.quit': 'Sair do Hermes Fleet',
    'update.upToDateTitle': 'Hermes Fleet',
    'update.upToDateMessage': 'Hermes Fleet esta atualizado.',
    'update.checkingTitle': 'Hermes Fleet',
    ...
    'update.availableMessage': 'Hermes Fleet {version} esta disponivel.',
    'update.downloading': 'A atualizacao esta sendo baixada em segundo plano.',
    'update.readyTitle': 'Atualizacao pronta',
    'update.readyMessage': 'Hermes Fleet {version} esta pronto para instalar.',
    ...
    'update.failedMessage': 'Nao foi possivel verificar atualizacoes do Hermes Fleet.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa o proxy de download do Hermes Fleet.',
